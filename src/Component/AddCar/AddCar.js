...
const AddCar = () => {
    ...
    const onSubmit = (data, e) => {
        ...
        fetch('https://stormy-tundra-94731.herokuapp.com/addCar', {
            method: 'POST',
            body: formData
        })
            ...
            <Container>
                <div className='mt-5'>
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Button className="Button-add-car-form mb-5 align-center" style={{maxWidth:'20px'}} type="submit">Send</Button>
                    </Form>
                </div>
            </Container>
        </div>
